...
import 'package:staff_management/utils/textField/email_field_widget.dart';
import 'package:staff_management/utils/textField/password_filed_widget.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  navigateToHome() async {
    EmployeeRepo userRepo = EmployeeRepo();
    await userRepo
        .fetchUser(FirebaseAuth.instance.currentUser!.uid)
        .then((value) => EmployeeRepo.employee = value);

    Get.offAllNamed('/mainContainer');
    showSnackbar(
        "Login succesful", 'Welcome ${EmployeeRepo.employee.name}', true);
  }
