...
import 'package:staff_management/screens/dashboard/addAddition/listEmployee.dart';
...
import 'additionEmployeeBottomSheet.dart';

class AddEmployeeAddition extends StatefulWidget {
  const AddEmployeeAddition({Key? key}) : super(key: key);

  @override
  _AddEmployeeAdditionState createState() => _AddEmployeeAdditionState();
}

class _AddEmployeeAdditionState extends State<AddEmployeeAddition> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height:
                _selectedEmployee.length == 0 ? 20 : _deviceSize.height * 0.53,
  ...
  void showSnackBar(BuildContext context, bool flag) {
    if (flag) {
      ...
      final snackBar = SnackBar(
        ...
        content: Text(
          "Add addition for employees successful",
